...
if(!empty($_POST['consulta'])) {
    ...
    $sql = "SELECT * FROM ospf WHERE id_ospf LIKE '%".$consulta."%' OR interface LIKE '%".$consulta."%' 
    OR costo LIKE '%".$consulta."%' OR prioridad LIKE '%".$consulta."%'
    OR estado LIKE '%".$consulta."%' OR instancia LIKE '%".$consulta."%' OR ip_ospf LIKE '%".$consulta."%'";
